...
export class SpecialtyService {
  ...
  getAllSpecialties(page: number = 0, size: number = 20): Observable<ApiResponse<SpecialtyResponse[]>> {
    return this.http.get<ApiResponse<SpecialtyResponse[]>>(this.API_URL, {
      params: {
        page,
        size,
      },
